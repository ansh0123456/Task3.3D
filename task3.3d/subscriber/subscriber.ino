...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == wave_topic) {
    ...
    client.publish(confirm_topic, "wave from Ansh received");
    Serial.println("wave from Ansh received - confirmation sent");
    ...
    client.publish(confirm_topic, "pat from Ansh received");
